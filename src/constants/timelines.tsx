...
export const timelineData: TimeLineType[] = [
  {
    ...
    responsibilities: [
      "Contributed to the build and design of internal software and automation systems to manage operations, reducing manual tasks by 40% and improving operational speed by 60%, which was crucial for business efficiency.",
      "Developed and designed the landing page along with a multi-step lead form to optimize user acquisition.",
      "Built and designed the mobile app for managers to streamline the management of temporary staff, including wireframing, prototyping, and feature ideation tailored for the B2B market."
    ]
  },
  {
    company: "Spot",
    ...
    responsibilities: [
      "Enhanced the existing landing page by improving UI/UX design and implementing new features.",
